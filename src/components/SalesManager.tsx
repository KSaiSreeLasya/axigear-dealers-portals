          ...
          <div className="invoice-print-modal-content bg-white rounded-xl max-w-4xl w-full border border-gray-300 shadow-2xl relative flex flex-col text-gray-800 font-sans my-8">
            ...
            <div className="p-4 md:p-6 space-y-3 font-sans text-[10px] leading-relaxed select-text" id="printable-gst-invoice-block">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 border-b border-gray-400 pb-4">
                <div className="space-y-1">
                  <h4 className="font-extrabold text-base tracking-tight text-gray-950">AXIGEAR ELECTRIC LOUNGE </h4>
              ...
              <div className="pt-8 grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="text-right space-y-4">
                  <span className="text-gray-400 font-bold block text-[9px]">For AXIGEAR ELECTRIC LOUNGE </span>
